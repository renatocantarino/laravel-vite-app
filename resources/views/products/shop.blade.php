                                ...
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                        <div class="card-badge-container left">
                                         ...
                                         <img src="{{asset('assets/img/'.$mw->image)}}" alt="Card image 2" class="card-img-top img-fluid"
                            ...
                            <div class="item">
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                      ...
                                      <img src="{{asset('assets/img/'.$vgs->image)}}" alt="Card image 2" class="card-img-top img-fluid"
                                           style="object-fit: cover; width: 100%; height: 200px;">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">
                             ...
                             <div class="item">
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                      ...
                                      <img src="{{asset('assets/img/'.$mp->image)}}" alt="Card image 2" class="card-img-top img-fluid"
                                           style="object-fit: cover; width: 100%; height: 200px;">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">
                            ...
                            <div class="item">
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                      ...
                                      <img src="{{asset('assets/img/'.$fish->image)}}" alt="Card image 2" class="card-img-top img-fluid"
                                           style="object-fit: cover; width: 100%; height: 200px;">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">
                            ...
                            <div class="item">
                                <div class="card card-product">
                                    ...
                                    <div class="card-badge">
                                      ...
                                      <img src="{{asset('assets/img/'.$frozen->image)}}" alt="Card image 2" class="card-img-top img-fluid"
                                           style="object-fit: cover; width: 100%; height: 200px;">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title">
