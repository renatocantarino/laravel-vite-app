...
@section('content')
    <div id="page-content" class="page-content">
        <x-banner-header title=" {{$product->name}} ">
                                    ...
                                    <div class="item">
                                        <div class="card card-product">
                                            ...
                                            <div class="card-badge">
                                                ...
                                                <img src="{{asset('assets/img/' . $rel->image)}}" alt="Card image 2"
                                                    class="card-img-top" style="object-fit: cover; width: 100%; height: 200px;">
                                            </div>
                                            <div class="card-body">
                                                <h4 class="card-title">
                                                ...
                                                <div class="card-price">
                                                    ...
                                                    <span class="reguler">R$
                                                        {{ number_format($rel->price + 30, 2, ',', '.') }}</span>
                                                </div>
